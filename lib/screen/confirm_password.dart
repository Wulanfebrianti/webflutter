                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30),
                      buildTextField("Buat Kata Sandi Baru",false, true, controller: usernameLogin_editTextController),
                      // button('Masuk', true),
                      SizedBox(height: 30),
                      Text(
                        'Bantu kami untuk melindungi data anda dengan',
                        style: TextStyle(
                          fontSize: 15,
                      ...
                      Text(
                        'membuat kata sandi yang kuat, minimal 8 karakter,',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                          color: Colors.black,
                      ...
                      Text(
                        'mengandung huruf kecil, huruf besar, dan angka.',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                          color: Colors.black,
                      ...
                      SizedBox(height: 30),
                      buildTextField("Konfirmasi Kata Sandi Baru",false, true, controller: usernameLogin_editTextController),
                      // button('Masuk', true),
